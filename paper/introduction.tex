...
Current multimodal Question Answering (QA) and Retrieval-Augmented Generation (RAG)~\cite{lewis2020rag} systems fail on complex scientific literature due to two main reasons:
\begin{enumerate}
...
\begin{itemize}
    \item \textbf{RQ 1:} How does an iterative, agentic reasoning loop improve factual accuracy and reduce hallucination on the SPIQA dataset~\cite{pramanick2024spiqa} compared to single-pass retrieval?
    \item \textbf{RQ 2:} How effectively can visual document embeddings (e.g., ColPali~\cite{faysse2025colpali}) be utilized by a multimodal agent to fetch necessary tables and figures?
